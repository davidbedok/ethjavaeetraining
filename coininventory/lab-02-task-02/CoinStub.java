...
public class CoinStub implements Serializable {
	...
	public CoinStub(String catalogNumber, DrawerStub drawer, int issuingYear, int value, String description, String observe, String reverse, double weight,
			CoinTypeStub type, QualityStub quality, int quantity, boolean whole) {
		super();
