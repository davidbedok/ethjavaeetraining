...
public class DrawerStub implements Serializable {
	...
	public String getDenomination(boolean whole) {
		return whole ? this.denominationWhole : this.denominationPart;
	}

	public String getDenomination() {
		return this.denominationWhole + "/" + this.denominationPart;
	}
