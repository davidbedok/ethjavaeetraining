...
psql -d coininventorydb -h localhost -p 5432 -U postgres -f schema/role.sql
...
psql -d coininventorydb -h localhost -p 5432 -U postgres -f schema/collector.sql
psql -d coininventorydb -h localhost -p 5432 -U postgres -f schema/collection.sql
psql -d coininventorydb -h localhost -p 5432 -U postgres -f schema/permission.sql
...
psql -d coininventorydb -h localhost -p 5432 -U postgres -f initial/role.sql
...
psql -d coininventorydb -h localhost -p 5432 -U postgres -f initial/collector.sql
psql -d coininventorydb -h localhost -p 5432 -U postgres -f initial/collection.sql
psql -d coininventorydb -h localhost -p 5432 -U postgres -f initial/permission.sql
